...
function makeItem(name, desc, imgPath){
    ...
    handle.replaceChildren(title,description)

    const img = document.createElement("img");
    img.src = imgPath;

    node.replaceChildren(handle,img);
...
const menu_border = document.createElement("div");
menu_border.classList.add("menu-border");
menu_border.replaceChildren(...items);

const menu_container = document.createElement("div");
menu_container.classList.add("menu-container");
menu_container.classList.add("js-tab");
menu_container.replaceChildren(menu_border);
